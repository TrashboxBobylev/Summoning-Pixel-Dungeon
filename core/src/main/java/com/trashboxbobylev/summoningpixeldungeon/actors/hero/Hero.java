...
import com.trashboxbobylev.summoningpixeldungeon.items.keys.CrystalKey;
...
import com.trashboxbobylev.summoningpixeldungeon.scenes.SurfaceScene;
...
import com.trashboxbobylev.summoningpixeldungeon.windows.WndResurrect;
	...
	public boolean handle( int cell ) {
		...
		if (Dungeon.level.map[cell] == Terrain.ALCHEMY && cell != pos) {
			...
			curAction = new HeroAction.Unlock( cell );
                ...
                && Dungeon.depth < 26) {
		    if (!((Dungeon.depth < 25 && Dungeon.depth > 21) && Dungeon.level.checkForFroggits())) {
