...
import com.trashboxbobylev.summoningpixeldungeon.actors.mobs.DwarfGuardMob;
import com.trashboxbobylev.summoningpixeldungeon.effects.particles.ShadowParticle;
import com.watabou.noosa.TextureFilm;

public class DwarfGuard extends MobSprite {

    protected Animation healing;
	...
	public DwarfGuard() {
        ...
        healing = new Animation( 8, false );
        healing.frames( frames, 11, 12, 13, 14 );
