...
import com.trashboxbobylev.summoningpixeldungeon.levels.rooms.special.PitRoom;
import com.trashboxbobylev.summoningpixeldungeon.levels.rooms.special.ShopRoom;
...
import com.trashboxbobylev.summoningpixeldungeon.levels.traps.WornDartTrap;
...
public abstract class RegularLevel extends Level {
	...
	protected void createMobs() {
		...
		int mobsToSpawn = Dungeon.depth == 1 ? 100 : nMobs();
