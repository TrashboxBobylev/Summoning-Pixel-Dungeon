...
public class Piranha extends Mob {
	...
	public Piranha() {
		...
		HP = HT = 10 + Dungeon.depth * 5 * 5 / Dungeon.chapterSize();
		defenseSkill = 10 + Dungeon.depth * 2 * 5 / Dungeon.chapterSize();
	}
	...
	public int damageRoll() {
		return Random.NormalIntRange( Dungeon.depth, 4 + Dungeon.depth * 2 * 5 / Dungeon.chapterSize() );
	}
	
	@Override
	public int attackSkill( Char target ) {
		return 20 + Dungeon.depth * 2 * 5 / Dungeon.chapterSize();
	}
	
	@Override
	public int drRoll() {
		return Random.NormalIntRange(0, Dungeon.depth * 5 / Dungeon.chapterSize());
	}
