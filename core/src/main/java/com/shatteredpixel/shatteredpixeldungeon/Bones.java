...
public class Bones {
	...
	public static void leave() {
		...
		if (Statistics.amuletObtained || (Statistics.deepestFloor - 5) >= depth || Dungeon.challenges.isConductedAtAll()) {
			depth = -1;
			return;
		}
		...
		if (Random.Int(3) != 0) {
			switch (Random.Int(7)) {
				...
				case 1:
					...
					break;
				case 2:
					item = hero.belongings.offenseAcc;
					break;
				case 3:
					item = hero.belongings.defenseAcc;
					break;
				case 4:
					item = hero.belongings.utilityAcc;
					break;
				case 5: case 6:
	...
	public static Item get() {
		if (depth == -1) {
			...
			if (depth == Dungeon.depth && !Dungeon.challenges.isConductedAtAll()) {
