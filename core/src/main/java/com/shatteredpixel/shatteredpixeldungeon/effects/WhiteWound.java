...
public class WhiteWound extends Image {

	private static final float TIME_TO_FADE = 0.45f;
	...
	public static void hit( Char ch, float angle ) {
		if (ch.sprite.parent != null) {
			WhiteWound w = (WhiteWound) ch.sprite.parent.recycle(WhiteWound.class);
	...
	public static void hit( int pos, float angle ) {
		...
		WhiteWound w = (WhiteWound)parent.recycle( WhiteWound.class );
