...
public class RunicParticle extends PixelParticle.Shrinking {

	public static final Factory MISSILE = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((RunicParticle)emitter.recycle( RunicParticle.class )).reset( x, y );
		}
	};
	...
	public static final Factory CURSE = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((RunicParticle)emitter.recycle( RunicParticle.class )).resetCurse( x, y );
		}
	};
	...
	public static final Factory UP = new Factory() {
		@Override
		public void emit( Emitter emitter, int index, float x, float y ) {
			((RunicParticle)emitter.recycle( RunicParticle.class )).resetUp( x, y );
		}
	};
	...
	public void update() {
		...
		color( ColorMath.interpolate( 0x38c3c3, 0x2c9999, p ) );
