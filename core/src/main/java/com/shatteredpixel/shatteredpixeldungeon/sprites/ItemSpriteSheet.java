...
public class ItemSpriteSheet {
	...
	public static final int KNIFE          = WEP_TIER1+1;
	public static final int GLOVES          = WEP_TIER1+2;
	public static final int SLINGSHOT          = WEP_TIER1+3;
	public static final int DAGGER          = WEP_TIER1+4;
	public static final int MAGES_STAFF     = WEP_TIER1+5;
	static{
		assignItemRect(WORN_SHORTSWORD, 13, 13);
        assignItemRect(KNIFE, 11, 12);
		assignItemRect(GLOVES,          12, 16);
        assignItemRect(SLINGSHOT,          13, 14);
	...
	public static final int SPIKE = WEP_TIER3+6;
	static{
	...
	public static final int STABBER = WEP_TIER4+6;
	static{
	...
	public static final int JJANGO = WEP_TIER5+6;
	public static final int BROADSWORD = WEP_TIER5+8;
	static{
    ...
    public static final int MIMIC_STAFF     = STAFFS+5;
    ...
    static {
        ...
        assignItemRect(MIMIC_STAFF, 16, 16);
	...
	public static final int ENCHANT         = SPELLS +13;
	static{
	...
	public static final int SCRAP      = QUEST+11;
	static{
    ...
    public static final int HEROIC_LEAP = POWERS+1;
